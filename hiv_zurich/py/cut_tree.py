from pastml.tree import read_tree, annotate_dates, DATE
...
if '__main__' == __name__:
    ...
    parser.add_argument('--min_year', type=int, default=2009)
    parser.add_argument('--max_year', type=int, default=2015)
    parser.add_argument('--root_year', type=int, default=1974)
    parser.add_argument('--forest', type=str)
    params = parser.parse_args()

    tree = read_tree(params.tree)
    annotate_dates([tree], root_dates=[params.root_year])
